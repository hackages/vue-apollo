      ...
      <template slot-scope="{ beer }">
        ...
        >
          ...
          <row>
            ...
            <sidebar-infos>
              <sidebar-infos-box>
                <infos-bold>{{ beer.average }}</infos-bold>Average rating
              </sidebar-infos-box>
              <sidebar-infos-box>
                <infos-bold>{{ beer.ibu }}</infos-bold>IBU
              </sidebar-infos-box>
              <sidebar-infos-box>
                <infos-bold>{{ beer.abv }}</infos-bold>ABV
              </sidebar-infos-box>
              <sidebar-infos-box>
                <infos-bold>nope</infos-bold>loyal drinker
              </sidebar-infos-box>
            </sidebar-infos>
          </row>
        </div>
